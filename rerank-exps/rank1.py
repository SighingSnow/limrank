...
class rank1(RerankerWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.eval_prompts = [
            "",
            f"Determine if the following passage is relevant to the query. Answer only with 'true' or 'false'.\n",
            f"Determine whether the following passage is relevant to answering the query or supporting its resolution. \n\nA relevant passage may include: \n1. Directly related information addressing the query. \n2. Foundational knowledge that prepares the context or understanding needed to answer the query. \n3. Content that supports, refutes, or examines the query from multiple perspectives. \n\nOther indirect relevance conditions may also apply. \n\nAdditionally, carefully evaluate if the passage contradicts or negates the query's premise (e.g., providing opposing evidence). \n\nAnswer strictly with 'true' or 'false' only."
        ]
    ...
    def return_prompt(self, query, doc_content, prompt) -> str:
        ...
        return "Determine if the following passage is relevant to the query. Answer only with 'true' or 'false'.\n" \
                f"Query: {query}\n" \
    ...
    def verbose_pred(self, input_to_rerank, **kwargs):
        ...
        return texts, token_counts, scores
